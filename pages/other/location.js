...
_core["default"].page({
  ...
  methods: _objectSpread({}, (0, _x.mapActions)(['setCurrentArea']), {
...
}, {info: {"components":{"van-nav-bar":{"path":"../../$vendor/@vant/weapp/dist/nav-bar/index"},"van-icon":{"path":"../../$vendor/@vant/weapp/dist/icon/index"},"van-loading":{"path":"../../$vendor/@vant/weapp/dist/loading/index"}},"on":{"22-0":["clickLeft"]}}, handlers: {'22-0': {"clickLeft": function proxy () {
    ...
    var _vm=this;
      return (function () {
        _vm.changeCity($event);
      })();
    
  }},'22-2': {"input": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        _vm.getSuggest($event);
      })();

...
_core["default"].page({
...
}, {info: {"components":{"van-nav-bar":{"path":"../../$vendor/@vant/weapp/dist/nav-bar/index"},"van-icon":{"path":"../../$vendor/@vant/weapp/dist/icon/index"},"van-loading":{"path":"../../$vendor/@vant/weapp/dist/loading/index"},"van-stepper":{"path":"../../$vendor/@vant/weapp/dist/stepper/index"},"van-notice-bar":{"path":"../../$vendor/@vant/weapp/dist/notice-bar/index"},"van-checkbox":{"path":"../../$vendor/@vant/weapp/dist/checkbox/index"},"van-popup":{"path":"../../$vendor/@vant/weapp/dist/popup/index"},"van-swipe-cell":{"path":"../../$vendor/@vant/weapp/dist/swipe-cell/index"},"van-image":{"path":"../../$vendor/@vant/weapp/dist/image/index"},"goods-list-column":{"path":"../../components/goodsListColumn"},"vip-price-box":{"path":"../../components/vipPriceBox"}},"on":{"11-0":["tap"],"11-5":["change"],"11-7":["minus","plus"],"11-10":["on-handle-cart"],"11-13":["close"]}}, handlers: {'11-0': {"tap": function proxy () {
  ...
  }},'11-4': {"tap": function proxy (activities) {
  ...
  }},'11-5': {"change": function proxy (key, index) {
  ...
  }},'11-7': {"minus": function proxy (key, index) {
  ...
  }},'11-9': {"tap": function proxy (key, index) {
  ...
  }},'11-10': {"on-handle-cart": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
  ...
  }},'11-14': {"touchmove": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        return($event);

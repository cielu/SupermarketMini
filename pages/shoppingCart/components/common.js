...
_core["default"].page({
            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                if (res.status === 'success') {
                  this.cartList = (0, _shoppingCart.formatCartByActivity)(res.data);
                  this.updateCartInfo();
                }
    ...
    onPlusGoodsNum: function onPlusGoodsNum(key, index) {
      ...
      (0, _cart.updateCartGoods)(data).then(function (res) {
        ...
        if (res.status === 'success') {
          ...
          _this5.updateCartInfo(); // util.toast('添加成功')
  ...
  onPageScroll: function onPageScroll(res) {
    console.log('on page scroll', res);
  },
...
}, {info: {"components":{"van-notice-bar":{"path":"../../../$vendor/@vant/weapp/dist/notice-bar/index"},"van-popup":{"path":"../../../$vendor/@vant/weapp/dist/popup/index"},"van-nav-bar":{"path":"../../../$vendor/@vant/weapp/dist/nav-bar/index"},"van-swipe-cell":{"path":"../../../$vendor/@vant/weapp/dist/swipe-cell/index"},"van-icon":{"path":"../../../$vendor/@vant/weapp/dist/icon/index"},"van-loading":{"path":"../../../$vendor/@vant/weapp/dist/loading/index"},"van-checkbox":{"path":"../../../$vendor/@vant/weapp/dist/checkbox/index"},"van-stepper":{"path":"../../../$vendor/@vant/weapp/dist/stepper/index"},"goods-list-column":{"path":"../../../components/goodsListColumn"},"vip-price-box":{"path":"../../../components/vipPriceBox"}},"on":{"63-64":["tap"],"63-69":["change"],"63-71":["minus","plus"],"63-74":["on-handle-cart"],"63-77":["close"]}}, handlers: {'63-64': {"tap": function proxy () {
  ...
  }},'63-68': {"tap": function proxy (activities) {
  ...
  }},'63-69': {"change": function proxy (key, index) {
  ...
  }},'63-71': {"minus": function proxy (key, index) {
  ...
  }},'63-73': {"tap": function proxy (key, index) {
  ...
  }},'63-74': {"on-handle-cart": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
  ...
  }},'63-78': {"touchmove": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        return($event);

...
_core["default"].page({
  ...
  methods: _objectSpread({}, (0, _x.mapActions)(['syncCurrentArea', 'initShoppingCart', 'addIntoCart', 'reduceCart']), {
    ...
    onPlusGoodsNum: function onPlusGoodsNum() {
      ...
      this.addIntoCart(addCartParam).then(function (_) {
  ...
  onShareAppMessage: function onShareAppMessage(options) {
    ...
    return {
      ...
      path: '/packageGoods/goods/detail?goodsCode=' + goods.goodsCode + '&fromUid=' + userInfo.userId,
      success: function success(res) {
        console.log('成功', res);
      }
    };
  }
}, {info: {"components":{"van-icon":{"path":"../../$vendor/@vant/weapp/dist/icon/index"},"van-loading":{"path":"../../$vendor/@vant/weapp/dist/loading/index"},"van-stepper":{"path":"../../$vendor/@vant/weapp/dist/stepper/index"},"van-popup":{"path":"../../$vendor/@vant/weapp/dist/popup/index"},"van-cell":{"path":"../../$vendor/@vant/weapp/dist/cell/index"},"van-goods-action":{"path":"../../$vendor/@vant/weapp/dist/goods-action/index"},"van-goods-action-icon":{"path":"../../$vendor/@vant/weapp/dist/goods-action-icon/index"},"van-goods-action-button":{"path":"../../$vendor/@vant/weapp/dist/goods-action-button/index"},"vip-price-box":{"path":"../../components/vipPriceBox"},"van-nav-bar":{"path":"../../$vendor/@vant/weapp/dist/nav-bar/index"}},"on":{"26-0":["clickLeft"],"26-2":["tap"],"26-3":["tap"],"26-4":["tap"],"26-8":["tap"],"26-9":["minus","plus"],"26-11":["tap"],"26-12":["close"],"26-16":["close"],"26-18":["close"],"26-22":["close"]}}, handlers: {'26-0': {"clickLeft": function proxy () {
  ...
  }},'26-6': {"tap": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        _vm.contactMerchant($event);
      })();
    
  }},'26-7': {"tap": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        _vm.showShopInfoModal($event);
  ...
  }},'26-13': {"touchmove": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        return($event);
  ...
  }},'26-14': {"markertap": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
  ...
  }},'26-17': {"touchmove": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        return($event);
  ...
  }},'26-19': {"touchmove": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        return($event);
  ...
  }},'26-20': {"tap": function proxy (attrVal, n, index) {
  ...
  }},'26-23': {"touchmove": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        return($event);
